...
schulverwaltungs_o.neuerKurs("A202", "Informatik", schulverwaltungs_o.sucheLehrer("Einstein"), schulverwaltungs_o.sucheRaum(202))
print(schulverwaltungs_o.kurse_ol[0].lehrer_o.vorname)
print(schulverwaltungs_o.kurse_ol[0].raum_o.nr)
