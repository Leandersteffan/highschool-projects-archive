...
class GUI:
    def __init__(self, modell):
        ...
        self.speichern_to_file_button = tk.Button(self.window, text="Speichern unter", command=self.open_file_explorer)
        self.speichern_to_file_button.grid(row=7, column=1, sticky="ew", padx=20, pady=20)
