...
class Vorfenster:
    def __init__(self):
        self.hauptfenster = Tk()
        self.hauptfenster.geometry('250x120')
        ...
        self.y_len_SCL = Scale(self.hauptfenster, from_=4, to=8, orient=HORIZONTAL, label="Feld Breite", background="lightgreen")
        ...
        self.start_BTN.place(x="50", y="80")
