...
class Gui:
    def __init__(self):
        ...
        self.feldgr_L = Label(self.hauptfenster, text="Feld größe ändern", bg='#578251')
        self.feldgr_L.place(x=830, y=330)

        self.matrix_xlen_SCL = Scale(self.hauptfenster, from_=4, to=8, orient=HORIZONTAL, bg='#578251', label="Width")
        self.matrix_xlen_SCL.place(x=830, y=360)
        self.matrix_xlen_SCL.set(8)
        self.matrix_ylen_SCL = Scale(self.hauptfenster, from_=3, to=8, orient=HORIZONTAL, bg='#578251', label="Heigth")
        self.matrix_ylen_SCL.place(x=830, y=430)
        self.matrix_ylen_SCL.set(8)
        ...
        self.reset_BTN = Button(self.hauptfenster, text="Feld festlegen", command=self.reset, width=20, height=2, bg='#578251')
        self.reset_BTN.place(x=830, y=500)
    ...
    def feld_ändern(self):
        self.feld = [[0]*self.matrix_xlen_SCL.get()]*self.matrix_ylen_SCL.get()
        self.springerproblem.feld = [[0] * self.matrix_xlen_SCL.get()] * self.matrix_ylen_SCL.get()
    ...
    def reset(self):
        ...
        self.springerproblem.feld = [[0]*self.matrix_xlen_SCL.get()]*self.matrix_ylen_SCL.get()
        print(self.feld, self.springerproblem.feld)
